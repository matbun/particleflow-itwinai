"""
Developing a PyTorch Geometric supervised training of MLPF using
DistributedDataParallel. Integration with itwinai.
...
# # itwinai parser is a wrapper of argparse.ArgumentParser, which allows
# # to load arguments from a configuration file
# from itwinai.parser import ArgumentParser

from itwinai.pipeline import Pipeline
from pyg.training_itwinai import MLPFTrainer
...
parser.add_argument(
    ...
    type=str,
    default=None,
    help="load checkpoint and start new training from epoch 1",
)
...
parser.add_argument(
    "--export-onnx", action="store_true", default=None, help="exports the model to onnx"
)
parser.add_argument(
    "--ntrain",
    type=int,
...
parser.add_argument(
    ...
    action="store_true",
    default=None,
    help="perform HPO locally, without a Ray cluster",
)
